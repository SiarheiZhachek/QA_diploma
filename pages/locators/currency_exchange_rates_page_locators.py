...
exchange_rate_nbrb_text = (By.XPATH, '//p[@class="title to-be-removed"]')
the_best_exchange_rate_in_the_converter = (By.XPATH, '//li[@class="bank to-be-removed"]/i/p')
the_best_exchange_rate = (By.XPATH, '//li[@class="bank to-be-removed"]/i/p/b')
estimated_mount = (By.XPATH, '//b[@class="js-cur-result"]')
